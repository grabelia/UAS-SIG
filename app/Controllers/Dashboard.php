...
// inisialisasi model kecamatan dan universitas
...
class Dashboard extends BaseController
{
   ...
   public function index(){
       ...
       // inisiasi object dari class UniversitasModel
       $universitas = new UniversitasModel();
       // mengambil semua data universitas
       $query = $universitas->findAll();
       $lokasi = '';
       $label_lokasi='';
       // perulangan untuk mempersiapkan data marker
       foreach ($query as $data_universitas) {
           $lokasi .= '["'.$data_universitas->no_universitas.'" ,"'.$data_universitas->nama_universitas.'","'.$data_universitas->alamat_universitas.'", '.$data_universitas->koordinat.'],';
       }
       $data['marker'] = $lokasi;
