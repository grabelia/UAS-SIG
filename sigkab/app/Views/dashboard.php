        ...
        <div class="col-9 d-flex">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var lokasi = <?php echo json_encode($marker); ?>;
                    for (var i = 0; i < lokasi.length; i++) {
                    let marker_label = 'NPSN: ' + lokasi[i].npsn + '<br>' + lokasi[i].nama_sekolah + '<br>' + lokasi[i].alamat_sekolah + '<br>STATUS: ' + lokasi[i].status;
                    marker = new L.marker([parseFloat(lokasi[i].latitude), parseFloat(lokasi[i].longitude)])
