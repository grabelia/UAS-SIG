...
echo form_dropdown('kode_kecamatan',$kecamatanOptions,$query-
>kode_kecamatan,'class="form-control"');
?>
</div>
<div class="mb-3">
...
<?php 
echo form_dropdown('status',$statusOptions,$query-
...
<?php 
echo form_dropdown('jenjang_pendidikan',$jenjangOptions,$query-
>jenjang_pendidikan,'class="form-control"');
?>
</div>
<div class="mb-3">
